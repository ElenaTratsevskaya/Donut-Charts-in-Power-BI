...
Кольцевая как и Круговая диаграмма имеет широкие возможности настройки. Можно менять угол поворота, управлять размером кружка отверстия, это помимо цветовых настроек и положения меток. Большой диапазон по выводу данных, главное сам процент посчитает, если ввести абсолютные значения, то не надо делать меры. <br> <br> 

*Стандартная кольцевая диаграмма* <br> 
![Для VC-1](https://github.com/user-attachments/assets/2e74c746-b781-450b-9fbf-d21ec5acd823) <br> 

Статья "From Boring to Brilliant: Transforming Donut Charts in Power BI: Chap -1" в Power BI Masterclass о творческом подходе к привычному виджету.<br> 

✴️ Идея выглядит простой: копи-паст построенной диаграммы > уменьшение размера каждой следующей и настройка цвета секций в ней > создание карточек вместо меток данных. <br> 
